...
- Exam opens in Moodle {{dates.exam.startdate}} at {{dates.exam.endtime}}.
- Students can start the exam anywhere and anytime they wish, as long as it's done before {{dates.exam.enddate}} at {{dates.exam.endtime}}.
...
- If you don't pass the exam, you can retake it for an unlimited amount of times, until {{dates.exam.enddate}}. There must be a week between each retake.
...
- You can earn up to 6 additional points by writing short essays about the subjects covered. Please contact the course organizers for instructions.
