...
Kun koet, että tehtävä on valmis, tee commit viestillä <code>Viikko 3. Toinen tehtävä</code> ja puske tehtävä Githubiin.
</div>
...
<li>Kun koet, että tehtävä on valmis, tee commit viestillä <code>Viikko 3. Kahdeksas tehtävä</code> ja puske tehtävä Githubiin.</li>
</ol>
</div>
...
<li>Kun koet, että tehtävä on valmis, tee commit viestillä <code>Viikko 3. Kymmenes tehtävä</code> ja puske tehtävä Githubiin.</li>
</ol>
</div>
...
<li>Kun koet, että tehtävä on valmis, tee commit viestillä <code>Viikko 3. Yhdestoista tehtävä</code> ja puske tehtävä Githubiin.</li>
</ol>
</div>
