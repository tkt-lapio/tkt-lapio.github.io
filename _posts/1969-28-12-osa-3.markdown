...
<li>Kun koet, että tehtävä on valmis, tee commit viestillä `Osa 3. Kahdeksas tehtävä` ja puske tehtävä Githubiin.</li>
</ol>
</div>
...
<li>Kun koet, että tehtävä on valmis, tee commit viestillä `Osa 3. Kymmenes tehtävä` ja puske tehtävä Githubiin.</li>
</ol>
</div>
...
<li>Kun koet, että tehtävä on valmis, tee commit viestillä `Osa 3. Yhdestoista tehtävä` ja puske tehtävä Githubiin.</li>
</ol>
</div>
