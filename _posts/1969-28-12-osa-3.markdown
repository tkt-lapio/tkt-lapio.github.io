...
Kun koet, että tehtävä on valmis, niin tee commit viestillä <code>Osa 3. Kolmas tehtävä</code> ja pushaa tehtävä Githubiin.
</div>
...
<li>Kun koet että tehtävä on valmis, niin tee commit viestillä <code>Osa 3. Seitsemäs tehtävä</code> ja pushaa tehtävä Githubiin.</li>
</ol>
</div>
