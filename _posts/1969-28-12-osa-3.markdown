...
Tässä on pala HTML-dokumentista, josta haluamme värittää kesäiset rivit punaisiksi. Tämä tapahtuu antamalla halutuille riveille luokkamääreen "kesa", jonka perusteella antaa niille värikkään tyylin.

```html
<p>
  <p class="kesa">Keltainen toukokuu, mikset sä jo tuu?</p>
  <p>Oon turhaan odottanut tuulta lempeää.</p>
  <p class="kesa">Kesä antaa kaikille onnen tunteen,</p>
  <p>jonka voi säilyttää</p>
</p>
```
