...
Helpoiten saa julkisen avaimen siirrettyä kohdepalvelimelle komennolla <code>scp</code>, jonka avulla on mahdollista kopioida tiedostoja palvelimelta toiselle (vrt komento `cp`). Komentoa käytetään seuraavasti:
