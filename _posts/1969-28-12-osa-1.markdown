...
<div class="note">
Mikäli loit avainparin itse määrittelemääsi polkuun, tarkenna yksityisen avaimen polku: <code>ssh -i polku/yksityiseen/avaimeen tunnus@palvelimen.osoite</code>.
</div>
