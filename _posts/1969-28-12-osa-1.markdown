...
{% include message.html type="warning" title="Poistaminen todellakin tarkoitaa poistamista" text=warn_no_trash %}
{% endcapture %}
...
{% include message.html type="info" title="Seuraaminen osastoja laitteilla" text=note_faculty_devices %}
