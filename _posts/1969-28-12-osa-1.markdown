...
<div class="exercise">
<h3>Tehtävä nro 1 {% include points.html text="5%" %}</h3>
...
<h3>Tehtävä nro 2 {% include points.html text="5%" %}</h3>
...
<div class="exercise">
<h3>Tehtävä nro 3 {% include points.html text="5%" %}</h3>
...
<div class="exercise">
<h3>Tehtävä nro 4 {% include points.html text="5%" %}</h3>
...
<div class="exercise">
<h3>Tehtävä nro 5 {% include points.html text="5%" %}</h3>
...
<div class="exercise">
<h3>Tehtävä nro 6 {% include points.html text="5%" %}</h3>
...
<div class="exercise">
<h3>Tehtävä nro 7 {% include points.html text="5%" %}</h3>
...
<div class="exercise">
<h3>Tehtävä nro 8 {% include points.html text="10%" %}</h3>
...
<div class="exercise">
<h3>Tehtävä nro 9 {% include points.html text="10%" %}</h3>
...
<div class="exercise">
<h3>Tehtävä 10  {% include points.html text="5%" %}</h3>
...
<div class="exercise">
<h3>Tehtävä nro 11 {% include points.html text="10%" %}</h3>
...
<div class="exercise">
<h3>Tehtävä nro 12 {% include points.html text="10%" %}</h3>
...
<div class="exercise">
<h3>Tehtävä nro 13 {% include points.html text="10%" %}</h3>
...
<div class="exercise">
<h3>Tehtävä 14 {% include points.html text="10%" %}</h3>
...
<div class="exercise">
<h3>Tehtävä nro 15 {% include points.html text="5%" %}</h3>
