...
{% endcapture %}
{% include exercise.html points="5%" title="Exercise 1: Setting up" content=exercise_auto_1 %}
...
{% endcapture %}{% include message.html type="info" text=message_info_1 title="There is always an another way" %}
...
{% endcapture %}{% include message.html type="info" text=message_info_2 title="Remember to use file name extensions" %}
...
{% endcapture %}
{% include exercise.html points="5%" title="Exercise 2: Getting to know text elements" content=exercise_auto_2 %}
...
{% endcapture %}{% include message.html type="info" text=message_info_3 title="Terminology" %}
...
{% endcapture %}
{% include exercise.html points="10%" title="Exercise 3: Nested elements" content=exercise_auto_3 %}
...
{% endcapture %}
{% include exercise.html points="10%" title="Exercise 4: Lists" content=exercise_auto_4 %}
...
{% endcapture %}{% include message.html type="warning" text=message_warning_1 title="Copyright" %}
...
{% endcapture %}
{% include exercise.html points="10%" title="Exercise 5: Images and comments" content=exercise_auto_5 %}
...
{% endcapture %}
{% include exercise.html points="10%" title="Exercise 6: Linking HTML files" content=exercise_auto_6 %}
...
{% endcapture %}
{% include exercise.html points="5%" title="Exercise 7: Linking CSS" content=exercise_auto_7 %}
...
{% endcapture %}
{% include exercise.html points="10%" title="Exercise 8: Selectors" content=exercise_auto_8 %}
...
Try adding elements inside others, and use the position property to change their locations.
{% endcapture %}{% include message.html type="info" text=message_info_4 title="Hint" %}

</ol>
{% endcapture %}
{% include exercise.html points="10%" title="Exercise 9: Aligned elements" content=exercise_auto_9 %}
...
{% endcapture %}
{% include exercise.html points="5%" title="Exercise 10: Practising CSS properties" content=exercise_auto_10 %}
...
{% endcapture %}
{% include exercise.html points="10%" title="Exercise 11: Making a site readable with CSS" content=exercise_auto_11 %}
...
We'll scroll down to the section called "GitHub pages" and publish the main branch by choosing it from the dropdown menu. GitHub will let you know once the site has been published:
...
{% endcapture %}{% include message.html type="info" text=message_info_5 title="University provided hosting space" %}
...
{% endcapture %}
{% include exercise.html points="10%" title="Exercise 12: A personal CV website" content=exercise_auto_12 %}
...
{% endcapture %}{% include message.html type="warning" text=message_warning_2 title="Give feedback" %}
