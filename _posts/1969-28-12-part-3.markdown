...
Now let's see how HTML works in practice. We'll open the file <code>index.html</code> created in the first exercise in a browser and a text editor. Tou can open the file in the browser by clicking on it in the graphical user interface, or explicitly opening it using a browser program from the command line.
...
<div class="exercise">
<h3>Exercise 6: HTML-tiedostojen linkittäminen {% include points.html text="10%" %}</h3>
<ol>
...
<div class="exercise">
<h3>Exercise 7: CSS:n linkittäminen {% include points.html text="5%" %}</h3>
<ol>
